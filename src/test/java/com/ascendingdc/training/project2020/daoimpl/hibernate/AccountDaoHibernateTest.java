...
public class AccountDaoHibernateTest extends AbstractDaoHibernateTest {
    private Logger logger = LoggerFactory.getLogger(AccountDaoHibernateTest.class);
    ...
    public static void setupOnce() {
        accountDao = new AccountDaoHibernateImpl();
