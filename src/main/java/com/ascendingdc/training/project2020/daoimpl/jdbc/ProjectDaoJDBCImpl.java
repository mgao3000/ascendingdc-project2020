...
//            preparedStatement.setLong(1, project.getId());
            ...
            preparedStatement.setTimestamp(3, Timestamp.valueOf(project.getCreateDate().atStartOfDay()));
...
//            String  SQL_SELECT_PROJECT_BY_ID = "SELECT * FROM PROJECT where id = ?";
            ...
            if(rs.next()) {
                ...
                retrievedProject.setCreateDate(createTimestamp.toLocalDateTime().toLocalDate());
            }
        }
        catch(Exception e){
